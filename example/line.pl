...
my @bw1 = qw(
    5.8 5.0 4.9 4.8 4.5 4.25 3.5 2.9 2.5 1.8 .9 .8 .5
);
my @bw2 = qw(
    .7 1.1 1.7 2.5 3.0 4.5 5.0 4.9 4.7 4.8 4.2 4.4 4
);
my @bw3 = qw(
    .3 1.4 1.2 1.5 4.0 3.5 2.0 1.9 2.7 4.2 3.2 1.1 9
);
...
# $def->range_axis->range->divvy_strategy('tight');
# $def->range_axis->format('%d');
# $def->domain_axis->tick_values([qw(2 4 6 8 10)]);
# $def->domain_axis->range->divvy_strategy('tight');
